...
class initialise:
    ...
    def start(self, cwd):
        ...
        cacheFile = "CachedDB"
        dirsCache = initialise.dirCacher(self, cwd=self.cwd) #tODO: Set return to list
        filesCache = initialise.filesCacher(self, cwd=self.cwd) #tODO: Set return to list
        ...
        Dirshelve['dirs'] = dirsCache #todo: saving the list to  the file
        Dirshelve.close()
